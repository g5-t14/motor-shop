                ...
                <ul className="flex flex-col gap-11">
                  <li className="flex flex-col gap-3">
                    ...
                    <p className="font-normal text-[14px] leading-6 text-grey2">
                      Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                      Veritatis ab tempore maxime earum esse, atque libero
                      nostrum suscipit voluptatem possimus temporibus tenetur
                      numquam consequatur cupiditate doloremque perspiciatis
                      nesciunt ratione voluptate!
                    </p>
                  </li>
                </ul>
              </section>
