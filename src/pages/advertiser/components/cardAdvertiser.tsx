...
export const CardAdvertiser = ({
  ...
  return (
    <>
      <div className="min-w-[312px] min-h-[350px] w-[312px] h-[350px] flex flex-col gap-4 mb-[85px]">
        <Link
          to={"/product/" + id}
          className="relative w-full border-2 border-transparent hover:border-2 hover:border-brand1"
        >
          {showTag(is_active)}
